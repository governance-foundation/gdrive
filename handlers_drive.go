...
import (
	...
	"github.com/governance-foundation/gdrive/auth"
	"github.com/governance-foundation/gdrive/cli"
	"github.com/governance-foundation/gdrive/drive"
)
...
func getOauthClient(args cli.Arguments) (*http.Client, error) {
	...
	if args.String("serviceAccount") != "" {
		...
		serviceAccountClient, err := auth.NewServiceAccountClient(serviceAccountPath, "file")
		if err != nil {
			return nil, err
		}
	...
	if args.String("serviceAccountEVar") != "" {
		serviceAccountClient, err := auth.NewServiceAccountClient(args.String("serviceAccountEVar"), "env")
		if err != nil {
			return nil, err
		}
		return serviceAccountClient, nil
	...
	if args.String("serviceAccountJson") != "" {
		serviceAccountClient, err := auth.NewServiceAccountClient(args.String("serviceAccountJson"), "json")
		if err != nil {
			return nil, err
		}
		return serviceAccountClient, nil
